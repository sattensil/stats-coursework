...
libname chap1 'C:\temp\Stats\Summer 2016\Summer 2016\Chapter 1';
libname chap2 'C:\temp\Stats\Summer 2016\Summer 2016\Chapter 2';
libname chap3 'C:\temp\Stats\Summer 2016\Summer 2016\Chapter 3';
libname chap4 'C:\temp\Stats\Summer 2016\Summer 2016\Chapter 4';
libname chap5 'C:\temp\Stats\Summer 2016\Summer 2016\Chapter 5';
libname chap9 'C:\temp\Stats\Summer 2016\Summer 2016\Chapter 9';
libname chap10 'C:\temp\Stats\Summer 2016\Summer 2016\Chapter 10';
libname chap11 'C:\temp\Stats\Summer 2016\Summer 2016\Chapter 11';
libname chap12 'C:\temp\Stats\Summer 2016\Summer 2016\Chapter 12';
libname chap13 'C:\temp\Stats\Summer 2016\Summer 2016\Chapter 13';
libname sasusers 'C:\temp\Stats\Summer 2016\Summer 2016\Data';
libname sasuser 'C:\temp\Stats\Summer 2016\Summer 2016\Data';
...
proc contents data=big_data2; 
 title 'big_data2'; 

 run; 

 proc print data=big_data2(obs=100); 
  title 'big_data2'; 
...
**From Book;
  ...
  proc print data=sasuser.sale2000(obs=100); 
   title 'sale2000'; 
 ...
 ****************************************************; 
 * Recreate problem with logistic regression 
 *****************************************************; 
...
**Step 1: Use all the variables; 
 ...
 proc logistic data = big_data_samp;
  class exercise(ref='0') smoke(ref='0') drug(ref='0')/param=ref;
  model death(event='1')  = smoke drug exercise weight height;
 title 'big data logistic regression';
...
**Step 2: Remove height and weight a/c they were insignificant.; 
...
**Step 3: Use earlier methods to get 10,000; 

   data systamatic;
    do pickit=1 to 1000000 by 100;

    set big_data_samp point=pickit;
...
**Step 4: Survey selce on death smoke drug and exercise; 

  proc sql;
create table big_data6 as
 select a.*
from big_data_samp a
order by a.death, a.smoke, a.drug,a.exercise
;
quit;

run;

proc surveyselect data=big_data6
       method=srs     n=10000      out=big_data_survey;
...
proc logistic data = big_data_survey;
  class exercise(ref='0') smoke(ref='0') drug(ref='0')/param=ref;
  model death(event='1')  = smoke drug exercise /*weight height*/;
 title 'Survey Results logistic regression';
