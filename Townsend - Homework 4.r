sink(file='C:/Users/Scarlett/Downloads/homework4.txt')
...
credit <- read.csv("C:/Users/Scarlett/Downloads/credit.csv")
str(credit)
...
## Step 2: Exploring and preparing the data ---- 
mushrooms <- read.csv("C:/Users/Scarlett/Downloads/mushrooms.csv", stringsAsFactors = TRUE)
